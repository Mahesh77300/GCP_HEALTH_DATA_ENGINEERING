...
GCS_BUCKET = "healthcare-bucket-0912"
...
BQ_PROJECT = "dataengineer-471916"
...
# MySQL Configuration
MYSQL_CONFIG = {
    "url": "jdbc:mysql://34.57.13.74:3306/hospital_b_db?useSSL=false&allowPublicKeyRetrieval=true",
...
def log_event(event_type, message, table=None):
    ...
    print(f"[{log_entry['timestamp']}] {event_type} - {message}") # Printing the logs in outpot console for visibility
